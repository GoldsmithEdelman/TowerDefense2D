...
import data.tower.tower3.ThirdProjectile;
...
public class Bank implements TowerBase  {
	...
	public Bank(Texture baseTexture,Texture crazyTexture, Tile startTile, float moneyPerEnemeyDead, ArrayList<Enemy> enemies, Menu menu) {
