...
public class ThirdTower implements TowerBase
{
    ...
    public ThirdTower(Texture baseTexture, Texture crazyTexture, Tile startTile,
    ...
    private void shoot()
    {
        ...
        {
            _projectiles
                .add(new ThirdProjectile(quickLoadPngTexture("Ball"), _target,
                        _enemies, _x + Game.TILE_SIZE / 2 - Game.TILE_SIZE / 4,
                        _y + Game.TILE_SIZE / 2 - Game.TILE_SIZE / 4, 32, 32,
                        300, _damage));
        }
    }
